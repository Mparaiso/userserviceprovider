...
class UserServiceProvider implements ServiceProviderInterface {
    ...
    public function boot(Application $app) {
        ...
        $app['templating'] = $app->share(function($app) {
                    return new \Mparaiso\User\Utils\TwigTemplating($app['twig']);
                }
        );
        ...
        $app['translator'] = $app->share($app->extend("translator", function($trans, $app) {
                            ...
                            /** add yaml translation loader * */
                            $trans->addLoader('yaml', new \Symfony\Component\Translation\Loader\YamlFileLoader());

                            $finder = new \Symfony\Component\Finder\Finder();
                            /** find yaml files * */
                            $finder->files()->name('*.yml')->in($app['fos_user.translator.resources']);
                            /** for each file , if file is validation resource , add to validation , else add to FOS... namespace * */
        ...
        /** twig * */
        $app['fos_user.template_path'] = $app->share(function() {
                    return __DIR__ . '/../User/Resources/views';
                }
        );
        $app['twig.loader.filesystem'] = $app->extend("twig.loader.filesystem", function($loader, $app) {
                    $loader->addPath($app['fos_user.template_path']);
                    return $loader;
                }
        );
    }
